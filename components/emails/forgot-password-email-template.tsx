...
export default function ForgotPasswordEmailTemplate({
  ...
  return (
    <Html>
      <Head />
      <Preview>
        A request has been made to reset the password of your MyFitHub account
      </Preview>
      <Tailwind>
        <Body style={main}>
          <Container style={container}>
            ...
            <Text style={title}>
              A request has been made to reset the password of your MyFitHub
              account
            </Text>
            <Section style={section}>
              <Text style={heading}>Hello {name},</Text>
              <Text style={subheading}>
                You may reset your password by following the link below. This
                link will expire in 1 hour.
              </Text>
              <Button
                style={button}
                href={`${process.env.NEXTAUTH_URL}/password-reset/${token}`}
              >
                Reset my password
              </Button>
              <Text style={text}>
              ...
              <Link style={link} className="break-words">
                {`${process.env.NEXTAUTH_URL}/password-reset/${token}`}
              </Link>
            </Section>
            <Section style={logo}>
              <Text style={text}>
