...
const ProgressChart = () => {
  ...
  return (
    <div className="">
      ...
      {isSSR && (<div className="flex justify-center items-center h-[225px]"><svg aria-hidden className="animate-spin h-20 w-20 text-zinc-600 fill-sky-800" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
