...
export default function ProgressChart({
  ...
  const CustomTooltip = ({ active, payload, label }: any) => {
    if (active && payload && payload.length) {
      ...
      return (
        <div className="rounded-md bg-black/80 p-2 pt-1 pb-1.5">
        ...
        <ResponsiveContainer width="100%" height={225}>
          ...
          >
            ...
            <Area
              ...
              fillOpacity={0.5}
              fill="url(#colorPv)"
              activeDot={{ strokeWidth: 1.8, r: 2.3, fill: '#1a1a1c', stroke: '#60d952' }}
            />
          </AreaChart>
        </ResponsiveContainer>
      ) : (
        <div className="flex justify-center items-center h-[225px]">
          <svg aria-hidden className="animate-spin h-20 w-20 text-stone-900 fill-[#60d952]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
