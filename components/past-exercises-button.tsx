...
export default function PastExercisesButton({
  ...
  return (
    <>
      <button className="text-zinc-200 hover:text-zinc-400 ml-px"
        onClick={() => setOpen(true)}
      >
        <GoHistory size={21.4} strokeWidth={0.8} />
      </button >
      <Modal open={open} onClose={() => setOpen(false)} className="flex justify-center items-center backdrop-blur-0 bg-black/50">
